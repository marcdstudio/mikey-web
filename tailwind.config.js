module.exports = {
  ...
  theme: {
    fontFamily: {
      tex: 'TeX Regular, sans-serif',
      texi: 'TeX Italic, sans-serif',
      texb: 'TeX Bold, sans-serif',
      texbi: 'TeX Bold Italic, sans-serif',
      mono: 'Monument, sans-serif',
      voy: 'Voyage Regular, serif',
      bota: 'Bota Regular, serif',
    },
    screens: {
      xs: '480px',
      sm: '768px',
